...
public interface SystemConfigService extends TGKSService
{
     ...
     * @throws
     */
    public List<SystemConfigEvt> querySystemConfigList(SystemConfigReq menuReq);
     ...
     * @throws
     */
    public int addSystemConfig(SystemConfigEvt menuEvt);
     ...
     * @throws
     */
    public int updateSystemConfig(SystemConfigEvt menuEvt);
