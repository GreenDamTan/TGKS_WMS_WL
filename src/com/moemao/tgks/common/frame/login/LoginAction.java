...
public class LoginAction extends TGKSAction
{
    ...
    public String login()
    {
        ...
        {
        	message = "密码错误";
        	CommonUtil.infoLog(logger, CommonConstant.SYSTEM_INFO_LOG_LOGIN_FAILD, "账号：" + userReq.getUsername() + " 密码：" + userReq.getPassword());
    		return ERROR;
        }
        ...
        // 菜单筛选
        this.userMenu();
        CommonUtil.infoLog(logger, CommonConstant.SYSTEM_INFO_LOG_LOGIN_SUCCESS, "账号：" + userReq.getUsername());
